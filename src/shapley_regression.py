...
target_feature = 'HbDrop'   # Clinical target outcome (Hemoglobin Drop)
...
count_out = 0
shapley_total = {}  # Stores aggregated Shapley values across all folds
...
for train_index, test_index in outer_cv.split(x):
    ...
    a_sampling = run_shapley_sampling(model, X_test_out, runs=runs, callback=callback)
...
output_excel_filename = f"nested_{target_feature}_{regressor_flag.upper()}_result.xlsx"
